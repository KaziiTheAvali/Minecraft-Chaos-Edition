...
execute as @a if entity @s[tag=stopped] run scoreboard players enable @s game_play
execute as @a if entity @s[tag=playing] run scoreboard players enable @s game_stop
